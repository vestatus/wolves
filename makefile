...
./obj/algorythms.o: ./src/tools/algorythms.cpp ./inc/tools/algorythms.hpp ./obj/containers.o
...
$(BIN): ./obj/graphics.o ./obj/containers.o ./obj/animals.o ./obj/random.o ./obj/logger.o ./obj/world.o ./obj/button.o ./obj/algorythms.o ./obj/main.o ./obj/worldgen.o
		g++ ./obj/graphics.o ./obj/containers.o ./obj/animals.o ./obj/random.o ./obj/logger.o ./obj/world.o ./obj/button.o ./obj/algorythms.o ./obj/main.o ./obj/worldgen.o -o $(BIN) -lsfml-graphics -lsfml-window -lsfml-system